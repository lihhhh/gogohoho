...
citySelector.cityInit = function (input,$compile,$scope) {
        ...
        $("#js_provList").on("click", ".provinceName", function () {
            function createUl(_this){
                ...
                for (var i = 0; i < cityArr.length; i++) {
                    cityHtmls += "<li class='js_cityName' ng-click=\"selectArea('"+cityArr[i]+"','"+input+"')\">" + cityArr[i] + "</li>";
                }
                cityHtmls += "</ul>";
                cityHtmls = $compile(cityHtmls)($scope);
                $("#js_provCitys").remove();
